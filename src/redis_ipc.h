...
//
// The unsubscribe function stops receiving notifications for settings changes.
int redis_ipc_subscribe_setting_notifications(void);
int redis_ipc_unsubscribe_setting_notifications(void);
...
// subscribed channel. This also will receive setting notifications as well
// as events or debug messages.
//
// At least one type of message should have been subscribed before listening.
